...
public class CrateRoomSettingScript : MonoBehaviour {
    ...
    //lan-
    public GameObject panel_Tensanshui;
    public GameObject panel_Purecolor;
    public GameObject panel_Sevenandthree;
    public GameObject panel_SevenmenOverlord;

    public Button Btn_Tensanshui_Liang;
    public Button Btn_Tensanshui_An;
    public Button Btn_Purecolor_Liang;
    public Button Btn_Purecolor_An;
    public Button Btn_Sevenandthree_Liang;
    public Button Btn_Sevenandthree_An;
    public Button Btn_SevenmenOverlord_Liang;
    public Button Btn_SevenmenOverlord_An;

    public List<Toggle> Tensanshui_Rules;
    public List<Toggle> Purecolor_Rules;
    public List<Toggle> Sevenandthress_Rules;
    public List<Toggle> Sevenmenlord_Rules;
    ...
    public void OpenTensanshui() //经典十三水界面
    {
        SoundCtrl.getInstance().playSoundByActionButton(1);
        GlobalDataScript.userGameType =GameType.GameType_Tensanshui ;
        setGameObjectActive(GlobalDataScript.userGameType);

        createRoom.onClick.RemoveAllListeners();
        createRoom.onClick.AddListener(createTensanshuiRoom);
    }
    public void OpenPurecolor() //疯狂纯一色界面
    {
        SoundCtrl.getInstance().playSoundByActionButton(1);
        GlobalDataScript.userGameType = GameType.GameType_Purecolor;
        setGameObjectActive(GlobalDataScript.userGameType);

        createRoom.onClick.RemoveAllListeners();
        createRoom.onClick.AddListener(createPurecolorRoom);
    }
    public void OpenSevenandthree() //七人加三色界面
    {
        SoundCtrl.getInstance().playSoundByActionButton(1);
        GlobalDataScript.userGameType = GameType.GameType_Sevenandthree;
        setGameObjectActive(GlobalDataScript.userGameType);

        createRoom.onClick.RemoveAllListeners();
        createRoom.onClick.AddListener(createSevenandthreeRoom);
    }
    public void OpenSevenmenOverlord() //七人霸王庄界面
    {
        SoundCtrl.getInstance().playSoundByActionButton(1);
        GlobalDataScript.userGameType = GameType.GameType_SevenmenOverlord;
        setGameObjectActive(GlobalDataScript.userGameType);

        createRoom.onClick.RemoveAllListeners();
        createRoom.onClick.AddListener(createSevenmenlordRoom);
    }
...
//	}
    ...
    void createTensanshuiRoom()  //十三水具体玩法房间的创建
    {
        sendVo = new RoomCreateVo();

        sendVo.gameType = (int)GameTypePK.Tensanshui;
        sendVo.typeOfTensanshui = (int)GameType.GameType_Tensanshui;
        string sendMessage = JsonMapper.ToJson(sendVo);
        ReqForCreateRoom(sendMessage);
    }
    void createPurecolorRoom()   //疯狂纯一色具体玩法房间创建
    {
        sendVo = new RoomCreateVo();

        sendVo.typeOfTensanshui = (int)GameType.GameType_Purecolor;
        sendVo.gameType = (int)GameTypePK.Tensanshui;

        string sendMessage = JsonMapper.ToJson(sendVo);
        ReqForCreateRoom(sendMessage);
    }
    void createSevenandthreeRoom()  // 七人加三色具体玩法房间创建
    {
        sendVo = new RoomCreateVo();

        sendVo.gameType = (int)GameTypePK.Tensanshui;
        sendVo.typeOfTensanshui = (int)GameType.GameType_Sevenandthree;
        string sendMessage = JsonMapper.ToJson(sendVo);
        ReqForCreateRoom(sendMessage);
    }
    void createSevenmenlordRoom()  //七人霸王庄具体玩法房间创建
    {
        sendVo = new RoomCreateVo();

        sendVo.gameType = (int)GameTypePK.Tensanshui;
        sendVo.typeOfTensanshui = (int)GameType.GameType_SevenmenOverlord;
        string sendMessage = JsonMapper.ToJson(sendVo);
        ReqForCreateRoom(sendMessage);
    }
    ...
    public void onCreateRoomCallback(ClientResponse response){
		...
		if (response.status == 1) {
            ...
            else if(GlobalDataScript.roomVo.gameType == (int)GameTypePK.Tensanshui 
                && GlobalDataScript.roomVo.typeOfTensanshui ==(int)GameType.GameType_Tensanshui){
                GlobalDataScript.gamePlayPanel = PrefabManage.loadPerfab("Prefab/");
            }
            else if (GlobalDataScript.roomVo.gameType == (int)GameTypePK.Tensanshui 
                && GlobalDataScript.roomVo.typeOfTensanshui ==(int)GameType.GameType_Purecolor){
              GlobalDataScript.gamePlayPanel = PrefabManage.loadPerfab("Prefab/");
            }
            else if (GlobalDataScript.roomVo.gameType == (int)GameTypePK.Tensanshui 
                && GlobalDataScript.roomVo.typeOfTensanshui==(int)GameType.GameType_Sevenandthree){
                GlobalDataScript.gamePlayPanel = PrefabManage.loadPerfab("Prefab/");
            }
            else if (GlobalDataScript.roomVo.gameType == (int)GameTypePK.Tensanshui 
                && GlobalDataScript.roomVo.typeOfTensanshui==(int)GameType.GameType_SevenmenOverlord){
                GlobalDataScript.gamePlayPanel = PrefabManage.loadPerfab("Prefab/");
            }
                closeDialog ();
...
//		panelZhuanzhuanSetting.SetActive(GameType.GameType_MJ_ZhuangZhuang == gt);
        ...
        //lan-    十三水
        panel_Tensanshui.SetActive(GameType.GameType_Tensanshui == gt);   
        panel_Purecolor.SetActive(GameType.GameType_Purecolor == gt);
        panel_Sevenandthree.SetActive(GameType.GameType_Sevenandthree == gt);
        panel_SevenmenOverlord.SetActive(GameType.GameType_SevenmenOverlord == gt);

        Btn_Tensanshui_Liang.gameObject.SetActive(GameType.GameType_Tensanshui == gt);
        Btn_Tensanshui_An.gameObject.SetActive(GameType.GameType_Tensanshui != gt);
        Btn_Purecolor_Liang.gameObject.SetActive(GameType.GameType_Purecolor == gt);
        Btn_Purecolor_An.gameObject.gameObject.SetActive(GameType.GameType_Purecolor != gt);
        Btn_Sevenandthree_Liang.gameObject.SetActive(GameType.GameType_Sevenandthree == gt);
        Btn_Sevenandthree_An.gameObject.SetActive(GameType.GameType_Sevenandthree != gt);
        Btn_SevenmenOverlord_Liang.gameObject.SetActive(GameType.GameType_SevenmenOverlord == gt);
        Btn_SevenmenOverlord_An.gameObject.SetActive(GameType.GameType_SevenmenOverlord != gt);
    }
}
